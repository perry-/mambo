  ...
  const actionHandlers = {
    ...
    'input.welcome': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        sendGoogleResponse('Hello, I am Drony!'); // Send simple response to user
      } else {
        sendResponse('Hello, I am Drony!'); // Send simple response to user
      }
    },
    ...
    'default': () => {
      ...
      if (requestSource === googleAssistantRequest) {
        let responseToUser = {
          ...
          speech: responses[Math.floor(Math.random()*responses.length)], // spoken response
          text: responses[Math.floor(Math.random()*responses.length)] // displayed response
        };
